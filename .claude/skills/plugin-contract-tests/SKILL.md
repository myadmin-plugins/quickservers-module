...
The class under contract here is `Detain\MyAdminQuickservers\Plugin`.
...
- This package declares `$module = 'quickservers'`. Changing it detaches the plugin from the events core dispatches to it, so the generated pin asserts it.
